...
function Create() {
  return (
    <div className="flex flex-col h-screen bg-orange-500 mx-auto  text-center ">
        <div>
            <p>Staff Overview</p>
        </div>
        <form className="">
          <div className="flex text-center p-3 justify-center border max-w-6xl   items-center flex-col gap-2">
