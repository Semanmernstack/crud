...
function List() {  
  ...
  return (
    <div className="overflow-x-hidden lg:max-w-7xl mx-auto  p-2 items-center   ">
        
        <p>Staff Employement List</p>

        
        <table className="  w-[100%]  border-1  flex flex-col " >
            ...
            <tbody>
                {
                    ...
                    <tr className="border-b" key={record.id}>
                        ...
                        <td className=" lg:py-6 lg:px-12 py-3 px-6">{record.email}</td>
                        <td className=" lg:py-6 lg:px-12 py-3 px-6">{record.sex}</td>
                        <td className=" lg:py-6 lg:px-12 py-3 px-6">{record.dept}</td>
                        <td className=" lg:py-6 lg:px-12 py-3 px-6">{record.phone}</td>
                    </tr>
                    ))
                }
